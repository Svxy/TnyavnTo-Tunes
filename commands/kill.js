module.exports = {
    name: "kill",
    description: "kill someone using TnyavnTo",
    options: [{
        name: "enemy",
        description: "Whos your enemy?",
        type: "MENTIONABLE",
        required: true
    }],
    async execute(interaction, args) {
        ...
        if (args.length == 0) {
            return interaction.reply("Damn, You trying to kill the air custer..??").then((msg) => setTimeout(() => msg.deleteReply(), 2300));
        }
        var kills = [
